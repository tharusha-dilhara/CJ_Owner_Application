...
class MonthlyreportsView extends StatefulWidget {
  const MonthlyreportsView({super.key});

  @override
  _MonthlyreportsViewState createState() => _MonthlyreportsViewState();
}

class _MonthlyreportsViewState extends State<MonthlyreportsView> {
  late Future<MonthlyReportData> futureReportData;
  final Report apiService = Report();

  @override
  void initState() {
    super.initState();
    futureReportData = apiService.fetchMonthlyReport();
  }
  ...
  Widget _buildHeaderCard(MonthlyReportData reportData) {
    return Card(
  ...
  Widget _buildPieChartCard(MonthlyReportData reportData) {
    return Card(
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(15),
      ),
